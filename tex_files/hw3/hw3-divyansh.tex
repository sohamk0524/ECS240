...
\end{tikzpicture}
      ...
      But we can see that node 3 doesn't have a unique immediate L-dominator, because the last strict L-dominator on Path 1 is node 2, while on Path 2 is node 4.
